...
${OBJECTDIR}/backup-util.o: backup-util.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/backup-util.o backup-util.c
...
${TESTDIR}/tests/setBackupStampTest.o: tests/setBackupStampTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/local/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/setBackupStampTest.o tests/setBackupStampTest.c
...
${OBJECTDIR}/backup-util_nomain.o: ${OBJECTDIR}/backup-util.o backup-util.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/backup-util_nomain.o backup-util.c;\
	else  \
